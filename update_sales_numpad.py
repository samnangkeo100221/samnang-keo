...
target = re.search(r'            \{\/\* Step 1: Quantity with quick chips \*\/\}.*?id="input-sale-quantity"', content, re.DOTALL)
if target:
...
content = content.replace('id="input-sale-cost-usd"', 'id="input-sale-cost-usd"\n                    onFocus={() => setActiveInput(\'unitCostUSD\')}')
content = content.replace('id="input-sale-cost-khr"', 'id="input-sale-cost-khr"\n                    onFocus={() => setActiveInput(\'unitCostKHR\')}')
